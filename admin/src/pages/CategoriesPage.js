...
const TABLE_HEAD = [
  ...
  { id: 'View', label: 'viewType', alignRight: false },
...
export default function CategoriesPage() {
  ...
  const LoadCategories = async () => {
    const response = await axios.get(`${API_URL}/categories?resultPerPage=100`);
                ...
                {Data.length > 0 ? (
                  <TableBody>
                    {Data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, i) => {
                      const { name, slug, description, viewType, _id } = row;
                      ...
                      return (
                        <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                          ...
                          <TableCell align="left">{viewType}</TableCell>
                          ...
                          >
                            ...
                            <MenuItem sx={{ color: 'error.main' }}>
                              <Iconify icon={'eva:trash-2-outline'} sx={{ mr: 2 }} onClick={() => console.log(row)} />
                              Delete
                            </MenuItem>
                          </Popover>
